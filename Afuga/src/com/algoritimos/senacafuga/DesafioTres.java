...
public class DesafioTres {
	...
	public static void desafioTres(String personagem, String user) throws Exception {
		String iniciar;
	...
	public static void alojamento(String user) throws Exception {
	...
	public static void escolha(String user) throws Exception {
	...
	public static void cozinha(String user) throws Exception{
	...
	public static void fim(String user) throws Exception {
