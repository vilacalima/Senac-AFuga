...
public class DesafioUm {
	...
	public static void desafioUm(String personagem) throws IOException {
		File arquivo = new File("Afuga/fases.txt");
		try (FileWriter salvar = new FileWriter(arquivo)) {
			...
			do {
				...
				resposta = "\n \n Apos a forte tempestade, voce acorda e se da conta do acontecido. "
						...
						+"Digite OLHAR para olhar ao redor \n";
				
				try {
					BufferedWriter escrever = new BufferedWriter(salvar); 
					escrever.write(resposta);
				} catch (IOException e) {
